...
const char* ssid = "ITL-spider";
const char* password = "hspider";
...
void loop(){
   ...
   }else if(CommOut == "w 6 3"){                        //~~~~~~~~ waving
     lastSpeed = StepSpeed;StepSpeed = 300;
     Move_WAV();StepSpeed = lastSpeed;CommOut=lastComm;
   }else if(CommOut == "w 15"){                         //~~~~~~~~ pos initial
    Pos_INT();CommOut=lastComm;
   }if(CommOut == "w 12"){                              //~~~~~~~~ pos service
    Pos_SRV();CommOut=lastComm;
   }else if(CommOut == "w 11 5"){                       //~~~~~~~~ adjust body left
    Adj_LF();CommOut=lastComm;
   }else if(CommOut == "w 10 5"){                       //~~~~~~~~ adjust body right
    Adj_RG();CommOut=lastComm;
   }else if(CommOut == "w 8 5"){                        //~~~~~~~~ adjust head up
    Adj_HU();CommOut=lastComm;
   }else if(CommOut == "w 9 5"){                        //~~~~~~~~ adjust head down
    Adj_HD();CommOut=lastComm;
   }else if(CommOut == "w 13"){                         //~~~~~~~~ adjust body higher
    Adj_HG();CommOut=lastComm;
   }else if(CommOut == "w 14"){                         //~~~~~~~~ adjust body lower
    Adj_LW();CommOut=lastComm;
   }else if(CommOut == "w 16"){                         //~~~~~~~~ adjust twist left
    Adj_TL();CommOut=lastComm;
   }else if(CommOut == "w 17"){                         //~~~~~~~~ adjust twist right
    Adj_TR();CommOut=lastComm;
   }else if(CommOut == "w 0 0"){                        //~~~~~~~~ adjust speed walk
    StepSpeed = 300;CommOut=lastComm;
   }else if(CommOut == "w 7 1"){                        //~~~~~~~~ adjust speed run
    StepSpeed = 50;CommOut=lastComm;
   }else if(CommOut == "w 20"){                         //~~~~~~~  claw close
    ClwCls();CommOut=lastComm;
   }else if(CommOut == "w 21"){                         //~~~~~~~~~~~ claw open
    ClwOpn();CommOut=lastComm;
   }else if(CommOut == "w 7 2"){                             //~~~~~~~~~~~ autoMode
    autoMode = !autoMode;
